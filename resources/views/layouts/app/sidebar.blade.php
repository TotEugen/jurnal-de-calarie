        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group heading="Platformă" class="grid">
                    ...
                    @endcan
                    @can('access-center')
                        <flux:sidebar.item icon="building-office-2" :href="route('center.dashboard')" :current="request()->routeIs('center.dashboard')" wire:navigate>Panou Centru</flux:sidebar.item>
                    @endcan
                    @can('access-monitor')
